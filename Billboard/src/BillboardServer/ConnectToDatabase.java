...
public class ConnectToDatabase {
    ...
    public static void createTablesIfNotExists(Connection con) {
        try {
            ...
            createTables.execute("CREATE TABLE IF NOT EXISTS `billboards` (`Name` varchar(256) NOT NULL,  `XML` longtext NOT NULL,  `CreatorName` varchar(256) NOT NULL,  PRIMARY KEY (`Name`));");
            ...
            createTables.execute("ALTER TABLE `billboards` ADD KEY IF NOT EXISTS `Billboard_CreatorName` (`CreatorName`),  ADD CONSTRAINT `Billboard_CreatorName` FOREIGN KEY IF NOT EXISTS (`CreatorName`) REFERENCES `users` (`Name`);");
